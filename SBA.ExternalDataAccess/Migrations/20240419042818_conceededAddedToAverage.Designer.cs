...
namespace SBA.ExternalDataAccess.Migrations
{
    ...
    [Migration("20240419042818_conceededAddedToAverage")]
    partial class conceededAddedToAverage
    {
            ...
            modelBuilder.Entity("Core.Entities.Concrete.ExternalDbEntities.LeagueStatisticsHolder", b =>
                {
                    ...
                    b.Property<DateTime>("DateOfAnalyse")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 19, 0, 0, 0, 0, DateTimeKind.Local));
