...
namespace SBA.ExternalDataAccess.Migrations
{
    ...
    [Migration("20230315213203_externalDbFirstMigration")]
    partial class externalDbFirstMigration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.Concrete.ExternalDbEntities.LeagueStatisticsHolder", b =>
                {
                    ...
                    b.Property<DateTime>("DateOfAnalyse")
                        ...
                        .HasDefaultValue(new DateTime(2023, 3, 16, 0, 0, 0, 0, DateTimeKind.Local));
            ...
            modelBuilder.Entity("Core.Entities.Concrete.ExternalDbEntities.StatisticsHolder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.Concrete.ExternalDbEntities.LeagueStatisticsHolder", b =>
                {
                    b.Navigation("StatisticsHolders");
                });
