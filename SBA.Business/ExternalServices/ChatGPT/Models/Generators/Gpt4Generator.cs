...
{
    public class Gpt4Generator : BaseEngineGenerator, IGptResponseGenerator
    {
        public Gpt4Generator(string apiKey) : base(apiKey)
        {
        }
        ...
        public async Task<string> GenerateResultAsync(List<RequestMessageGPT> messages, RequestConfigGPT requestConfiguration)
        {
            ...
            requestConfiguration ??= new RequestConfigGPT(800, 0.01f);
            ...
            try
            {
                ...
                new ChatRequest
                {
                    ...
                    Model = EngineModelConstants.GPT_4
                });
