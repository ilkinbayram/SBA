...
namespace SBA.Business.BusinessHelper
{
    public static class OperationalProcessor
    {
        ...
        public static List<StatisticInfoHolder> GenerateOddPercentageStatInfoes(int serial, List<FilterResultMutateModel> resultModel, decimal range)
        {
            ...
            else if (resultModel.Count < 10) return new List<StatisticInfoHolder>();
            ...
            var result = new List<StatisticInfoHolder>
            {
                new StatisticInfoHolder(Guid.Empty, 0, "Count_Percent_Found".TranslateResource(2), resultModel.Count.ToString(), resultModel.Count.ToString(), resultModel.Count, resultModel.Count, serial, (int)StatisticType.OddPercentage, 0),
                new StatisticInfoHolder(Guid.Empty, 100, "Ind_Avg_Goal_FT".TranslateResource(2), input.Average_FT_Goals_HomeTeam.ToString("0.00"), input.Average_FT_Goals_AwayTeam.ToString("0.00"), input.Average_FT_Goals_HomeTeam, input.Average_FT_Goals_AwayTeam, serial, (int)StatisticType.OddPercentage, 0),
                new StatisticInfoHolder(Guid.Empty, 103, "Ind_Avg_Conc_Goal_FT".TranslateResource(2), input.Average_FT_Conceded_Goals_HomeTeam.ToString("0.00"), input.Average_FT_Conceded_Goals_AwayTeam.ToString("0.00"), input.Average_FT_Conceded_Goals_HomeTeam, input.Average_FT_Conceded_Goals_AwayTeam, serial, (int)StatisticType.OddPercentage, 0),
                new StatisticInfoHolder(Guid.Empty, 105, "Ind_Avg_Goal_HT".TranslateResource(2), input.Average_HT_Goals_HomeTeam.ToString("0.00"), input.Average_HT_Goals_AwayTeam.ToString("0.00"), input.Average_HT_Goals_HomeTeam, input.Average_HT_Goals_AwayTeam, serial, (int)StatisticType.OddPercentage, 0),
                new StatisticInfoHolder(Guid.Empty, 107, "Ind_Avg_Conc_Goal_HT".TranslateResource(2), input.Average_HT_Conceded_Goals_HomeTeam.ToString("0.00"), input.Average_HT_Conceded_Goals_AwayTeam.ToString("0.00"), input.Average_HT_Conceded_Goals_HomeTeam, input.Average_HT_Conceded_Goals_AwayTeam, serial, (int)StatisticType.OddPercentage, 0),
                new StatisticInfoHolder(Guid.Empty, 110, "Ind_Avg_Goal_SH".TranslateResource(2), input.Average_SH_Goals_HomeTeam.ToString("0.00"), input.Average_SH_Goals_AwayTeam.ToString("0.00"), input.Average_SH_Goals_HomeTeam, input.Average_SH_Goals_AwayTeam, serial, (int)StatisticType.OddPercentage, 0),
                new StatisticInfoHolder(Guid.Empty, 113, "Ind_Avg_Conc_Goal_SH".TranslateResource(2), input.Average_SH_Conceded_Goals_HomeTeam.ToString("0.00"), input.Average_SH_Conceded_Goals_AwayTeam.ToString("0.00"), input.Average_SH_Conceded_Goals_HomeTeam, input.Average_SH_Conceded_Goals_AwayTeam, serial, (int)StatisticType.OddPercentage, 0),
                new StatisticInfoHolder(Guid.Empty, 115, "Ind_FT_Win".TranslateResource(2), string.Format("{0}%", input.Is_FT_Win1), string.Format("{0}%", input.Is_FT_Win2), (decimal)input.Is_FT_Win1 / 100, (decimal)input.Is_FT_Win2 / 100, serial, (int)StatisticType.OddPercentage, 0),
                new StatisticInfoHolder(Guid.Empty, 120, "FT_X".TranslateResource(2), string.Format("{0}%", input.Is_FT_X), string.Format("{0}%", input.Is_FT_X), (decimal)input.Is_FT_X / 100, (decimal)input.Is_FT_X / 100, serial, (int)StatisticType.OddPercentage, 0),
                new StatisticInfoHolder(Guid.Empty, 125, "Ind_HT_Win".TranslateResource(2), string.Format("{0}%", input.Is_HT_Win1), string.Format("{0}%", input.Is_HT_Win2), (decimal)input.Is_HT_Win1 / 100, (decimal)input.Is_HT_Win2 / 100, serial, (int)StatisticType.OddPercentage, 0),
                new StatisticInfoHolder(Guid.Empty, 130, "HT_X".TranslateResource(2), string.Format("{0}%", input.Is_HT_X), string.Format("{0}%", input.Is_HT_X), (decimal)input.Is_HT_X / 100, (decimal)input.Is_HT_X / 100, serial, (int)StatisticType.OddPercentage, 0),
                new StatisticInfoHolder(Guid.Empty, 135, "Ind_SH_Win".TranslateResource(2), string.Format("{0}%", input.Is_SH_Win1), string.Format("{0}%", input.Is_SH_Win2), (decimal)input.Is_SH_Win1 / 100, (decimal)input.Is_SH_Win2 / 100, serial, (int)StatisticType.OddPercentage, 0),
                new StatisticInfoHolder(Guid.Empty, 140, "SH_X".TranslateResource(2), string.Format("{0}%", input.Is_SH_X), string.Format("{0}%", input.Is_SH_X), (decimal)input.Is_SH_X / 100, (decimal)input.Is_SH_X / 100, serial, (int)StatisticType.OddPercentage, 0),
                new StatisticInfoHolder(Guid.Empty, 145, "Ind_FT_05".TranslateResource(2), string.Format("{0}%", input.Home_FT_05_Over), string.Format("{0}%", input.Away_FT_05_Over), (decimal)input.Home_FT_05_Over / 100, (decimal)input.Away_FT_05_Over / 100, serial, (int)StatisticType.OddPercentage, 0),
                new StatisticInfoHolder(Guid.Empty, 150, "Ind_FT_15".TranslateResource(2), string.Format("{0}%", input.Home_FT_15_Over), string.Format("{0}%", input.Away_FT_15_Over), (decimal)input.Home_FT_15_Over / 100, (decimal)input.Away_FT_15_Over / 100, serial, (int)StatisticType.OddPercentage, 0),
                new StatisticInfoHolder(Guid.Empty, 155, "Ind_HT_05".TranslateResource(2), string.Format("{0}%", input.Home_HT_05_Over), string.Format("{0}%", input.Away_HT_05_Over), (decimal)input.Home_HT_05_Over / 100, (decimal)input.Away_HT_05_Over / 100, serial, (int)StatisticType.OddPercentage, 0),
                new StatisticInfoHolder(Guid.Empty, 160, "Ind_HT_15".TranslateResource(2), string.Format("{0}%", input.Home_HT_15_Over), string.Format("{0}%", input.Away_HT_15_Over), (decimal)input.Home_HT_15_Over / 100, (decimal)input.Away_HT_15_Over / 100, serial, (int)StatisticType.OddPercentage, 0),
                new StatisticInfoHolder(Guid.Empty, 165, "Ind_SH_05".TranslateResource(2), string.Format("{0}%", input.Home_SH_05_Over), string.Format("{0}%", input.Away_SH_05_Over), (decimal)input.Home_SH_05_Over / 100, (decimal)input.Away_SH_05_Over / 100, serial, (int)StatisticType.OddPercentage, 0),
                new StatisticInfoHolder(Guid.Empty, 170, "Ind_SH_15".TranslateResource(2), string.Format("{0}%", input.Home_SH_15_Over), string.Format("{0}%", input.Away_SH_15_Over), (decimal)input.Home_SH_15_Over / 100, (decimal)input.Away_SH_15_Over / 100, serial, (int)StatisticType.OddPercentage, 0),
                new StatisticInfoHolder(Guid.Empty, 142, "Ind_WinAny".TranslateResource(2), string.Format("{0}%", input.Home_Win_Any_Half), string.Format("{0}%", input.Away_Win_Any_Half), (decimal)input.Home_Win_Any_Half / 100, (decimal)input.Away_Win_Any_Half / 100, serial, (int)StatisticType.OddPercentage, 0),

                new StatisticInfoHolder(Guid.Empty, 175, "FT_GG".TranslateResource(2), string.Format("{0}%", input.FT_GG), string.Format("{0}%", input.FT_GG), (decimal)input.FT_GG / 100, (decimal)input.FT_GG / 100, serial, (int)StatisticType.OddPercentage, 0),
                new StatisticInfoHolder(Guid.Empty, 180, "HT_GG".TranslateResource(2), string.Format("{0}%", input.HT_GG), string.Format("{0}%", input.HT_GG), (decimal)input.HT_GG / 100, (decimal)input.HT_GG / 100, serial, (int)StatisticType.OddPercentage, 0),
                new StatisticInfoHolder(Guid.Empty, 185, "SH_GG".TranslateResource(2), string.Format("{0}%", input.SH_GG), string.Format("{0}%", input.SH_GG), (decimal)input.SH_GG / 100, (decimal)input.SH_GG / 100, serial, (int)StatisticType.OddPercentage, 0),
                new StatisticInfoHolder(Guid.Empty, 190, "FT_15".TranslateResource(2), string.Format("{0}%", input.FT_15_Over), string.Format("{0}%", input.FT_15_Over), (decimal)input.FT_15_Over / 100, (decimal)input.FT_15_Over / 100, serial, (int)StatisticType.OddPercentage, 0),
                new StatisticInfoHolder(Guid.Empty, 195, "FT_25".TranslateResource(2), string.Format("{0}%", input.FT_25_Over), string.Format("{0}%", input.FT_25_Over), (decimal)input.FT_25_Over / 100, (decimal)input.FT_25_Over / 100, serial, (int)StatisticType.OddPercentage, 0),
                new StatisticInfoHolder(Guid.Empty, 200, "FT_35".TranslateResource(2), string.Format("{0}%", input.FT_35_Over), string.Format("{0}%", input.FT_35_Over), (decimal)input.FT_35_Over / 100, (decimal)input.FT_35_Over / 100, serial, (int)StatisticType.OddPercentage, 0),
                new StatisticInfoHolder(Guid.Empty, 205, "HT_05".TranslateResource(2), string.Format("{0}%", input.HT_05_Over), string.Format("{0}%", input.HT_05_Over), (decimal)input.HT_05_Over / 100, (decimal)input.HT_05_Over / 100, serial, (int)StatisticType.OddPercentage, 0),
                new StatisticInfoHolder(Guid.Empty, 210, "HT_15".TranslateResource(2), string.Format("{0}%", input.HT_15_Over), string.Format("{0}%", input.HT_15_Over), (decimal)input.HT_15_Over / 100, (decimal)input.HT_15_Over / 100, serial, (int)StatisticType.OddPercentage, 0),
                new StatisticInfoHolder(Guid.Empty, 215, "SH_05".TranslateResource(2), string.Format("{0}%", input.SH_05_Over), string.Format("{0}%", input.SH_05_Over), (decimal)input.SH_05_Over / 100, (decimal)input.SH_05_Over / 100, serial, (int)StatisticType.OddPercentage, 0),
                new StatisticInfoHolder(Guid.Empty, 220, "SH_15".TranslateResource(2), string.Format("{0}%", input.SH_15_Over), string.Format("{0}%", input.SH_15_Over), (decimal)input.SH_15_Over / 100, (decimal)input.SH_15_Over / 100, serial, (int)StatisticType.OddPercentage, 0)
            };

            if (input.Average_FT_Corners_HomeTeam >= 0 && input.Average_FT_Corners_AwayTeam >= 0)
            {
                result.Add(new StatisticInfoHolder(Guid.Empty, 50, "Ind_Poss_FT".TranslateResource(2), string.Format("{0}%", input.Home_Possesion), string.Format("{0}%", input.Away_Possesion), (decimal)input.Home_Possesion / 100, (decimal)input.Away_Possesion / 100, serial, (int)StatisticType.OddPercentage, 0));
                result.Add(new StatisticInfoHolder(Guid.Empty, 104, "Ind_Avg_GK_Saves_FT".TranslateResource(2), input.Average_FT_GK_Saves_HomeTeam.ToString("0.00"), input.Average_FT_GK_Saves_AwayTeam.ToString("0.00"), input.Average_FT_GK_Saves_HomeTeam, input.Average_FT_GK_Saves_AwayTeam, serial, (int)StatisticType.OddPercentage, 0));

                result.Add(new StatisticInfoHolder(Guid.Empty, 55, "Ind_Avg_Shut_FT".TranslateResource(2), input.Average_FT_Shut_HomeTeam.ToString("0.00"), input.Average_FT_Shut_AwayTeam.ToString("0.00"), input.Average_FT_Shut_HomeTeam, input.Average_FT_Shut_AwayTeam, serial, (int)StatisticType.OddPercentage, 0));
                result.Add(new StatisticInfoHolder(Guid.Empty, 60, "Ind_Avg_ShutOnTrg_FT".TranslateResource(2), input.Average_FT_ShutOnTarget_HomeTeam.ToString("0.00"), input.Average_FT_ShutOnTarget_AwayTeam.ToString("0.00"), input.Average_FT_ShutOnTarget_HomeTeam, input.Average_FT_ShutOnTarget_AwayTeam, serial, (int)StatisticType.OddPercentage, 0));

                result.Add(new StatisticInfoHolder(Guid.Empty, 300, "Ind_Avg_Corner_FT".TranslateResource(2), input.Average_FT_Corners_HomeTeam.ToString("0.00"), input.Average_FT_Corners_AwayTeam.ToString("0.00"), input.Average_FT_Corners_HomeTeam, input.Average_FT_Corners_AwayTeam, serial, (int)StatisticType.OddPercentage, 0));

                result.Add(new StatisticInfoHolder(Guid.Empty, 330, "Ind_Cor3_5_FT".TranslateResource(2), string.Format("{0}%", input.Corner_Home_3_5_Over), string.Format("{0}%", input.Corner_Away_3_5_Over), (decimal)input.Corner_Home_3_5_Over / 100, (decimal)input.Corner_Away_3_5_Over / 100, serial, (int)StatisticType.OddPercentage, 0));
                result.Add(new StatisticInfoHolder(Guid.Empty, 335, "Ind_Cor4_5_FT".TranslateResource(2), string.Format("{0}%", input.Corner_Home_4_5_Over), string.Format("{0}%", input.Corner_Away_4_5_Over), (decimal)input.Corner_Home_4_5_Over / 100, (decimal)input.Corner_Away_4_5_Over / 100, serial, (int)StatisticType.OddPercentage, 0));
                result.Add(new StatisticInfoHolder(Guid.Empty, 340, "Ind_Cor5_5_FT".TranslateResource(2), string.Format("{0}%", input.Corner_Home_5_5_Over), string.Format("{0}%", input.Corner_Away_5_5_Over), (decimal)input.Corner_Home_5_5_Over / 100, (decimal)input.Corner_Away_5_5_Over / 100, serial, (int)StatisticType.OddPercentage, 0));

                result.Add(new StatisticInfoHolder(Guid.Empty, 345, "Cor7_5_FT".TranslateResource(2), string.Format("{0}%", input.Corner_7_5_Over), string.Format("{0}%", input.Corner_7_5_Over), (decimal)input.Corner_7_5_Over / 100, (decimal)input.Corner_7_5_Over / 100, serial, (int)StatisticType.OddPercentage, 0));
                result.Add(new StatisticInfoHolder(Guid.Empty, 350, "Cor8_5_FT".TranslateResource(2), string.Format("{0}%", input.Corner_8_5_Over), string.Format("{0}%", input.Corner_8_5_Over), (decimal)input.Corner_8_5_Over / 100, (decimal)input.Corner_8_5_Over / 100, serial, (int)StatisticType.OddPercentage, 0));
                result.Add(new StatisticInfoHolder(Guid.Empty, 355, "Cor9_5_FT".TranslateResource(2), string.Format("{0}%", input.Corner_9_5_Over), string.Format("{0}%", input.Corner_9_5_Over), (decimal)input.Corner_9_5_Over / 100, (decimal)input.Corner_9_5_Over / 100, serial, (int)StatisticType.OddPercentage, 0));

                result.Add(new StatisticInfoHolder(Guid.Empty, 360, "Ind_Cor_Win".TranslateResource(2), string.Format("{0}%", input.Is_Corner_FT_Win1), string.Format("{0}%", input.Is_Corner_FT_Win2), (decimal)input.Is_Corner_FT_Win1 / 100, (decimal)input.Is_Corner_FT_Win2 / 100, serial, (int)StatisticType.OddPercentage, 0));
                result.Add(new StatisticInfoHolder(Guid.Empty, 365, "Cor_X".TranslateResource(2), string.Format("{0}%", input.Is_Corner_FT_X), string.Format("{0}%", input.Is_Corner_FT_X), (decimal)input.Is_Corner_FT_X / 100, (decimal)input.Is_Corner_FT_X / 100, serial, (int)StatisticType.OddPercentage, 0));
            }
